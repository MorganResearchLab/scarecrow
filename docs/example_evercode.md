...
# ------------------------------------------------------------------------------------------------------
# Generate kNN data and save as RData for later analysis
# ------------------------------------------------------------------------------------------------------
mamba activate samtools_env
sbatch --partition uoa-compute ./scarecrow/scripts/kNN.sh --in ${PROJECT}/kallisto --out ${PROJECT}/kallisto
# 2536305

files <- list.files(path = args[1], recursive = T, full = T, pattern = "cells_x_genes.mtx")
