...
<table>
  <tr>
    <td><img src="../img/scale_index_0_forward.png" alt="Barcode profiles for FASTQ index 0, forward orientation" width="45%"></td>
    <td><img src="../img/scale_index_1_reverse.png" alt="Barcode profiles for FASTQ index 1, reverse orientation" width="45%"></td>
  </tr>
  <tr>
    <td><img src="../img/scale_index_2_forward.png" alt="Barcode profiles for FASTQ index 2, forward orientation" width="45%"></td>
    <td><img src="../img/scale_index_2_reverse.png" alt="Barcode profiles for FASTQ index 2, reverse orientation" width="45%"></td>
  </tr>
  <tr>
    <td><img src="../img/scale_index_3_forward.png" alt="Barcode profiles for FASTQ index 3, forward orientation" width="45%"></td>
    <td><img src="../img/scale_index_3_reverse.png" alt="Barcode profiles for FASTQ index 3, reverse orientation" width="45%"></td>
  </tr>
</table>
<br>
