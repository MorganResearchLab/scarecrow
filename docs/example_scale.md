...
FASTQS=(${PROJECT}/fastq/SRR28867557_3.fastq.gz ${PROJECT}/fastq/SRR28867557_4.fastq.gz)
...
<br>
<picture>
  <img alt="Plot of barcode profiles" src="../img/scale_harvest.png" width=80% style="display: block; margin-left: auto; margin-right: auto;">
</picture>
<br>
...
BC1:lig,read1,forward,1,9,9408,1.0,0.0406
BC2:rt,read1,forward,24,33,4977,0.58,0.0193
```
