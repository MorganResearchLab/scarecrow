...
The plots generated by `harvest` indicates that barcode matches were found on read 1 (SRR28867557_1.fastq.gz) in forward orientation at positions 1, and read 2 (SRR28867557_3.fastq.gz) in forward orentation at positions and 24-25. This is consistent with the expectation from the (0-based) library structure described in the ScaleRna JSON [https://github.com/ScaleBio/ScaleRna/blob/master/references/libV1.1.i5_rc.json](https://github.com/ScaleBio/ScaleRna/blob/master/references/libV1.1.i5_rc.json). SRR28867557_2.fastq.gz returned a conserved sequence, indicated by the red shading. No matches were identified on SRR28867557_1.fastq.gz for barcodes in reverse orientation, or on SRR28867557_2.fastq.gz for barcodes in forward orientation. Matches were identified on SRR28867557_3.fastq.gz for barcodes in reverse orientation, and for SRR28867557_4.fastq.gz for barcodes in either orientation, resulting in plots being generated, although the counts were insignificant and returned no peaks.
